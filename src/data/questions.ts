...
const questions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { id: 'c', text: '先给每个人倒水，问题可以以后再说', weights: [{ persona: 'MOM', weight: 2 }, { persona: 'DEAD', weight: 1 }, { persona: 'OJBK', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '找客户、谈价格、做能收钱的交付', value: 0, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'KING', weight: 1 }, { persona: 'COIN', weight: 3 }] },
      { id: 'b', text: '产品和商业各做一点，主要看当天焦虑什么', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'WIND', weight: 1 }] },
      { id: 'c', text: '研究新技术、改愿景、给项目换更高级的名字', value: 4, weights: [{ persona: 'WIKI', weight: 2 }, { persona: 'PAIN', weight: 1 }, { persona: 'PURE', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '先做一个最烂版本，现实自然会教育我', value: 0, weights: [{ persona: 'WIND', weight: 1 }, { persona: 'BOSS', weight: 1 }, { persona: 'RUSH', weight: 3 }] },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '看见我早就说过我会成功，截图都留着呢', weights: [{ persona: 'BOSS', weight: 3 }, { persona: 'KING', weight: 1 }, { persona: 'COIN', weight: 1 }] },
      { id: 'b', text: '看见我经历了多少没人理解的孤独', weights: [{ persona: 'PAIN', weight: 3 }, { persona: 'LOOP', weight: 2 }] },
      { id: 'c', text: '最好别看见我，看看我的方法论就行', weights: [{ persona: 'WIKI', weight: 3 }, { persona: 'SAFE', weight: 1 }, { persona: 'LOOP', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '先听完，但保留“他可能不懂”的最后尊严', value: 2, weights: [{ persona: 'SAFE', weight: 2 }, { persona: 'NOPE', weight: 1 }] },
      { id: 'c', text: '坚持自己。伟大的人最初都不被理解', value: 4, weights: [{ persona: 'KING', weight: 2 }, { persona: 'PAIN', weight: 1 }, { persona: 'NOPE', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '记进笔记，偶尔还能想起它住在哪一页', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'RULE', weight: 1 }, { persona: 'LOOP', weight: 1 }] },
      { id: 'c', text: '进入收藏夹，和另外 846 条知识幸福团聚', value: 4, weights: [{ persona: 'WIKI', weight: 3 }, { persona: 'DEAD', weight: 1 }, { persona: 'LOOP', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '十分钟后已经买好域名，名字就叫未来', weights: [{ persona: 'WIND', weight: 3 }, { persona: 'BOSS', weight: 1 }, { persona: 'RUSH', weight: 3 }] },
      { id: 'b', text: '先列 18 个风险，成功压制自己全部冲动', weights: [{ persona: 'SAFE', weight: 3 }, { persona: 'RULE', weight: 1 }] },
      { id: 'c', text: '把群友叫来开会，我负责当创始人', weights: [{ persona: 'KING', weight: 2 }, { persona: 'BOSS', weight: 2 }, { persona: 'COIN', weight: 1 }] },
    ],
  },
  {
    ...
    title: '关于风口，你最认同哪句话？',
    options: [
      { id: 'a', text: '哪有钱去哪，迁徙也是一种坚定', value: 0, weights: [{ persona: 'WIND', weight: 3 }, { persona: 'RUSH', weight: 1 }, { persona: 'COIN', weight: 2 }] },
      { id: 'b', text: '主线不变，偶尔蹭一下时代的顺风车', value: 2, weights: [{ persona: 'BOSS', weight: 1 }, { persona: 'SAFE', weight: 1 }] },
      { id: 'c', text: '真正的长期主义者不应该被短期利益诱惑', value: 4, weights: [{ persona: 'RULE', weight: 2 }, { persona: 'PAIN', weight: 1 }, { persona: 'PURE', weight: 1 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'c', text: '队友不行、时机不对、平台限流，证据确凿', value: 4, weights: [{ persona: 'KING', weight: 3 }, { persona: 'NOPE', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '立刻接管他的人生，顺便帮他安排到下季度', weights: [{ persona: 'MOM', weight: 3 }, { persona: 'KING', weight: 1 }, { persona: 'OJBK', weight: 1 }] },
      { id: 'b', text: '发一篇 9000 字资料：先理解问题的本质', weights: [{ persona: 'WIKI', weight: 3 }] },
      { id: 'c', text: '明早再回。很多人生问题睡一觉就像没看见', weights: [{ persona: 'DEAD', weight: 3 }, { persona: 'LATER', weight: 3 }, { persona: 'OJBK', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '已经发了，还被现实打出了几个补丁', value: 0, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'WIND', weight: 1 }, { persona: 'RUSH', weight: 1 }] },
      { id: 'b', text: '还在微调，但它至少还活在硬盘里', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'RULE', weight: 2 }, { persona: 'LATER', weight: 2 }] },
      { id: 'c', text: '暂缓发布。世界还没准备好，我也没有', value: 4, weights: [{ persona: 'RULE', weight: 2 }, { persona: 'PAIN', weight: 1 }, { persona: 'DEAD', weight: 1 }, { persona: 'LATER', weight: 2 }, { persona: 'PURE', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '承认就行，欲望又没要求写思想汇报', value: 0, weights: [{ persona: 'WIND', weight: 1 }, { persona: 'KING', weight: 1 }, { persona: 'COIN', weight: 2 }] },
      { id: 'b', text: '可以想，但最好包装得对社会有点价值', value: 2, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'MOM', weight: 1 }, { persona: 'COIN', weight: 3 }] },
      { id: 'c', text: '人应该追求更高尚的东西，至少公开场合是', value: 4, weights: [{ persona: 'RULE', weight: 1 }, { persona: 'PAIN', weight: 2 }, { persona: 'PURE', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '写一篇深度复盘，重点描写这段经历如何塑造我', weights: [{ persona: 'PAIN', weight: 2 }, { persona: 'BOSS', weight: 2 }, { persona: 'LOOP', weight: 3 }] },
      { id: 'b', text: '重新制定流程，下次任何人都必须按标准来', weights: [{ persona: 'RULE', weight: 3 }] },
      { id: 'c', text: '等大家忘了。互联网每天都有新的烂尾', weights: [{ persona: 'DEAD', weight: 3 }, { persona: 'WIND', weight: 1 }, { persona: 'LATER', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '先答应争取一下，人总要被目标逼一把', value: 2, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'MOM', weight: 1 }, { persona: 'LATER', weight: 1 }] },
      { id: 'c', text: '让对方先安心，未来的我自然会想办法', value: 4, weights: [{ persona: 'MOM', weight: 2 }, { persona: 'DEAD', weight: 1 }, { persona: 'LATER', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '已经有人用、有人骂，最好还有人付钱', value: 0, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'KING', weight: 1 }, { persona: 'RUSH', weight: 2 }, { persona: 'COIN', weight: 2 }] },
      { id: 'b', text: '做了一半，另一半正在等待情绪和奇迹', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'DEAD', weight: 1 }, { persona: 'LATER', weight: 2 }] },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '纠正他的语气。错误可以改，态度不能惯', weights: [{ persona: 'KING', weight: 3 }, { persona: 'NOPE', weight: 3 }] },
      { id: 'b', text: '笑着说没事，回去后反复回放到凌晨三点', weights: [{ persona: 'PAIN', weight: 2 }, { persona: 'SAFE', weight: 1 }] },
      { id: 'c', text: '转移话题维护气氛，错误留给命运处理', weights: [{ persona: 'DEAD', weight: 3 }, { persona: 'MOM', weight: 1 }, { persona: 'OJBK', weight: 3 }] },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'c', text: '不能忽视环境，逆风局失败不代表决策有错', value: 4, weights: [{ persona: 'PAIN', weight: 1 }, { persona: 'KING', weight: 2 }, { persona: 'NOPE', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '“你懂得不多。”——请坐下，我从第一性原理讲', weights: [{ persona: 'WIKI', weight: 3 }, { persona: 'NOPE', weight: 1 }] },
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '拿它解决过真实问题，最好还因此收过钱', value: 0, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'COIN', weight: 2 }] },
      { id: 'b', text: '能讲清楚原理，也做过几个练习', value: 2, weights: [{ persona: 'RULE', weight: 1 }, { persona: 'WIKI', weight: 1 }] },
      { id: 'c', text: '建立完整知识体系，暂时没用不代表没价值', value: 4, weights: [{ persona: 'WIKI', weight: 3 }, { persona: 'LOOP', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '听了一半，另一半时间在判断他够不够资格', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'KING', weight: 1 }, { persona: 'LOOP', weight: 2 }, { persona: 'NOPE', weight: 2 }] },
      { id: 'c', text: '找三个支持我的人，成功完成民主验证', value: 4, weights: [{ persona: 'KING', weight: 2 }, { persona: 'MOM', weight: 1 }, { persona: 'NOPE', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '先开另一个更兴奋的新项目，曲线救国', weights: [{ persona: 'WIND', weight: 3 }, { persona: 'RUSH', weight: 3 }] },
      { id: 'c', text: '不决定。时间会替成年人完成很多脏活', weights: [{ persona: 'DEAD', weight: 3 }, { persona: 'LATER', weight: 3 }] },
    ],
  },
  {
    ...
    title: '一个产品什么时候应该上线？',
    options: [
      { id: 'a', text: '能解决一点问题就上，让用户参与打磨', value: 0, weights: [{ persona: 'WIND', weight: 1 }, { persona: 'BOSS', weight: 1 }, { persona: 'RUSH', weight: 1 }] },
      { id: 'b', text: '核心体验过关再上，别拿用户当测试耗材', value: 2, weights: [{ persona: 'RULE', weight: 2 }] },
      { id: 'c', text: '等它足够代表我的审美和能力，否则宁可不发', value: 4, weights: [{ persona: 'RULE', weight: 2 }, { persona: 'PAIN', weight: 2 }, { persona: 'PURE', weight: 2 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '直接说想要，然后研究怎么合法得到', value: 0, weights: [{ persona: 'BOSS', weight: 1 }, { persona: 'WIND', weight: 1 }, { persona: 'COIN', weight: 3 }] },
      { id: 'b', text: '承认一半，再补一句“主要还是创造价值”', value: 2, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'MOM', weight: 1 }, { persona: 'COIN', weight: 3 }] },
      { id: 'c', text: '公开鄙视它，私下每十分钟刷新一次数据', value: 4, weights: [{ persona: 'PAIN', weight: 2 }, { persona: 'RULE', weight: 1 }, { persona: 'PURE', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '安排大家去实现我已经想好的宏大计划', weights: [{ persona: 'KING', weight: 2 }, { persona: 'BOSS', weight: 2 }, { persona: 'RUSH', weight: 2 }, { persona: 'COIN', weight: 1 }] },
      { id: 'c', text: '让大家别吵、互相理解，然后最好别找我', weights: [{ persona: 'DEAD', weight: 2 }, { persona: 'MOM', weight: 2 }, { persona: 'OJBK', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      { id: 'a', text: '赚钱。有人付钱至少说明它没完全自嗨', value: 0, weights: [{ persona: 'BOSS', weight: 2 }, { persona: 'KING', weight: 1 }, { persona: 'COIN', weight: 3 }] },
      { id: 'b', text: '商业和作品都要，成年人不做单选题', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'RULE', weight: 1 }] },
      { id: 'c', text: '追求纯粹价值，钱只是世界迟到的掌声', value: 4, weights: [{ persona: 'PAIN', weight: 2 }, { persona: 'WIKI', weight: 1 }, { persona: 'PURE', weight: 3 }] },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 'b', text: '完成一半，剩下一半由“最近有点忙”负责', value: 2, weights: [{ persona: 'SAFE', weight: 1 }, { persona: 'MOM', weight: 1 }, { persona: 'LATER', weight: 1 }, { persona: 'OJBK', weight: 2 }] },
      { id: 'c', text: '有些承诺已经被聊天记录考古学永久封存', value: 4, weights: [{ persona: 'DEAD', weight: 3 }, { persona: 'WIND', weight: 1 }, { persona: 'LATER', weight: 3 }] },
    ],
  },
]
